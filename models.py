...
class Models:
    ...
    def knn_model(self):
        ...
        # Тестовая выборка
        accuracy_knn_test = accuracy_score(self.y_test, y_test_pred_knn)
    ...
    def tree_model(self):
        ...
        y_test_pred_dt = dt_classifier.predict(self.X_test)
        ...
        # Тестовая выборка
        accuracy_dt_test = accuracy_score(self.y_test, y_test_pred_dt)
        print("\nТЕСТОВАЯ ВЫБОРКА:")
    ...
    def logisticRegression_model(self):
        ...
        accuracy_lr_test = accuracy_score(self.y_test, y_test_pred_lr)
        print("\nТЕСТОВАЯ ВЫБОРКА:")
